...
const SessionSchema = new mongoose.Schema({
  ...
  // Specific sub-topic this session targets (adaptive learning insertions only)
  topic:           { type: String,  default: '' },
  // True when this session was inserted automatically by the adaptive
  // engine (repeated weak topic) rather than the original AI/fallback schedule.
